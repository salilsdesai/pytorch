...
static void init(void) {
  ...
  pytorch_qnnp_params.q8dw27 = (struct pytorch_q8dwconv_mp_parameters){
      .mpdw = pytorch_q8dwconv_ukernel_mp8x27__neon,
      .mpdw_per_channel = pytorch_q8dwconv_ukernel_mp8x27_per_channel__neon,
      .cr = 8,
  };
  ...
  pytorch_qnnp_params.q8dw27 = (struct pytorch_q8dwconv_mp_parameters){
      .mpdw = pytorch_q8dwconv_ukernel_mp8x25__sse2, // TODO
      .mpdw_per_channel = pytorch_q8dwconv_ukernel_mp8x25_per_channel__sse2, // TODO
      .cr = 8,
  };
